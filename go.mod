...
require (
	...
	github.com/openshift/library-go v0.0.0-20240205190119-68f38a5e48af
...
// If velero version is updated, update the replace below for k8s imports to the new version
replace github.com/vmware-tanzu/velero => github.com/openshift/velero v0.10.2-0.20231024175012-d8101a298016

// Replace the following k8s.io dependencies with the versions specified in the velero go.mod from the replace above
replace (
